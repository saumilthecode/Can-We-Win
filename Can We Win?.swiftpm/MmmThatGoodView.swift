...
@available(iOS 16.0, *)
struct MmmThatGoodView: View {
    
    @State private var x1 = 0
    @State private var y1 = 0
    
    @State private var x2 = -50
    @State private var y2 = -40
    
    @State private var x3 = -900
    @State private var y3 = -900
        ...
        NavigationStack{
            ...
            VStack {
                ...
                if isShowingNext {
                    ...
                    NavigationLink(destination: OhnoView()) {
                        Text("Next View!")
                            .padding()
